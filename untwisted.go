...
func newbpcurve(twisted elliptic.Curve, gx, gy, z *big.Int) *bpcurve {
	var curve bpcurve
...
func initP160r1() {
	...
	p160r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP192r1() {
	...
	p192r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP224r1() {
	...
	p224r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP256r1() {
	...
	p256r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP320r1() {
	...
	p320r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP384r1() {
	...
	p384r1 = newbpcurve(twisted, gx, gy, z)
}
...
func initP512r1() {
	...
	p512r1 = newbpcurve(twisted, gx, gy, z)
}
